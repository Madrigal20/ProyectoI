...
namespace ProyectoI.Clases
{
    ...
    {
        //Atributos
        private const int LIMITE_MANTENIMIENTO = 100;
        ...
        public Bicicleta(int capacidadMaxima) : base(ValidarCapacidad(capacidadMaxima)) { }
        ...
        public override void RecordatorioMantenimiento()
        {
            ...
            if (!mantenimientoPendiente && KmUltimoMantenimiento >= LIMITE_MANTENIMIENTO)
            {
                ...
                Console.WriteLine("Mantenimiento requerido: Se alcanzaron 1.00Km desde el último mantenimiento.");
            }

            if (Estado == EstadoVehiculo.Mantenimiento)
            {
                Console.WriteLine("La bicicleta está en mantenimiento. Realice el servicio para continuar.");
            }
            else
            {
                Console.WriteLine($"Bicicleta operativa. \n Próximo mantenimiento en {LIMITE_MANTENIMIENTO - KmUltimoMantenimiento} Km.");
            }
        }
        ...
        public void RealizarMantenimiento()
        {
            if (Estado == EstadoVehiculo.Mantenimiento)
            {
                ...
                Console.WriteLine("Mantenimiento realizado. Bicileta Operativa nuevamente. ");
            }
            else
            {
                Console.WriteLine("La bicicleta no necesita mantenimiento por ahora. ");
            }
        }
